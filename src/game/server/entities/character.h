...
public:
	...
	void Die(int Killer, int Weapon, float respawnSecs=3.f);
...
public:
	...
	void SetRelativePos(vec2 pos) { m_Core.m_Pos += pos; }
	void SetHookOthers(bool on);
	void SetHitOthers(bool on);
	void SetCollideOthers(bool on);
	void SetSuperJump(bool on);
	bool CanHitOthers() { return m_Hit == HIT_ALL; }
	bool CanHookOthers() { return m_Core.m_Hook; }
	bool CanCollideOthers() { return m_Core.m_Collision; }
