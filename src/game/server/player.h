...
public:
	...
	// headbot
	bool IsOut() { return m_Team == TEAM_SPECTATORS and not m_voluntarySpectator; }
	bool IsVoluntarySpectator() const { return m_Team == TEAM_SPECTATORS and m_voluntarySpectator; }
